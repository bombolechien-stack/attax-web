  ...
  return (
    <section style={{
      ...
      <div style={{ maxWidth: "600px", margin: "0 auto" }}>
        <p className="section-label-light" style={{ margin: "0 0 2rem" }}>Download</p>
        <h2 style={{
          fontSize: "clamp(2.5rem, 5vw, 4.5rem)", fontWeight: 800,
          color: "#ffffff", letterSpacing: "-0.045em", lineHeight: 1.0, margin: "0 0 1.5rem",
        }}>
          Ready to enter<br />the arena?
        </h2>
        <p style={{ fontSize: "1.0625rem", color: "rgba(255,255,255,0.4)", lineHeight: 1.75, margin: "0 auto 3rem", maxWidth: "380px" }}>
        ...
        <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap" }}>
          <a href="https://apps.apple.com" target="_blank" rel="noopener noreferrer" style={{
            ...
            padding: "15px 30px", borderRadius: "999px", textDecoration: "none",
          }}>
          ...
          <a href="https://play.google.com" target="_blank" rel="noopener noreferrer" style={{
            display: "inline-flex", alignItems: "center", gap: "10px",
            backgroundColor: "rgba(255,255,255,0.09)", color: "rgba(255,255,255,0.85)", fontWeight: 600, fontSize: "0.9375rem",
            padding: "15px 30px", borderRadius: "999px", textDecoration: "none",
