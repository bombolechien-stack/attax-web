    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: "600px", margin: "0 auto" }}>
        ...
        <h2 style={{ fontSize: "clamp(2.5rem, 5vw, 4.5rem)", fontWeight: 800, color: "#ffffff", letterSpacing: "-0.045em", lineHeight: 1.0, margin: "0 0 1.5rem" }}>
          <span style={{ ...fadeUp(visible, 80), display: "block" }}>Ready to enter</span>
          <span style={{ ...fadeUp(visible, 230), display: "block" }}>the arena?</span>
        </h2>
        <p style={{ ...fadeUp(visible, 400), fontSize: "1.0625rem", color: "rgba(255,255,255,0.4)", lineHeight: 1.75, margin: "0 auto 3rem", maxWidth: "380px" }}>
          Download Attax and start turning your activity into victories.
        </p>
        <div style={{ ...fadeUp(visible, 540), display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap" }}>
