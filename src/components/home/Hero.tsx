...
export default function Hero() {
  return (
    /* White page background visible on sides = "screen" effect */
    <div style={{
      ...
      <section style={{
        ...
        <div style={{
          ...
          <div className="animate-fade-up" style={{
            ...
            <div style={{
              ...
              backgroundColor: "rgba(252,95,43,0.2)",
        ...
        <div className="animate-fade-up delay-500" style={{
          position: "relative", zIndex: 2,
          display: "flex", padding: "0 4rem 3.5rem", gap: "0",
        }}>
          {[
