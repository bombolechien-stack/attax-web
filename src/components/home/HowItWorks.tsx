  ...
  return (
    <section id="how-it-works" style={{ backgroundColor: "#ffffff", padding: "10rem 0" }}>
      <div style={{ maxWidth: "80rem", margin: "0 auto", padding: "0 2rem" }}>
        ...
        <div>
          {h.steps.map((s, i) => (
            <div key={i} style={{ display: "grid", gridTemplateColumns: "80px 1fr", gap: "0", padding: "4rem 0", borderBottom: "1px solid #ebebeb", alignItems: "start" }}>
              <div style={{ fontSize: "clamp(3.5rem, 5vw, 5rem)", fontWeight: 900, color: "#ebebeb", letterSpacing: "-0.05em", lineHeight: 1, paddingTop: "0.1em" }}>
                {String(i + 1).padStart(2, "0")}
              </div>
              <div style={{ paddingLeft: "3rem" }}>
                <div style={{ fontSize: "clamp(2.5rem, 4.5vw, 5rem)", fontWeight: 800, color: "#0d0d0d", letterSpacing: "-0.05em", lineHeight: 0.95, marginBottom: "1.5rem" }}>{s.title}</div>
