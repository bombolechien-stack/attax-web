        ...
        <InView>
          <div style={{
            ...
            <div className="glow-pulse" style={{
              ...
              borderRadius: "50%",
              background: "radial-gradient(circle, rgba(252,95,43,0.25) 0%, transparent 65%)",
              pointerEvents: "none",
            }} />
            {/* Grid pattern */}
            <div style={{
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <h2 style={{
                ...
                margin: "0 0 1rem", lineHeight: 1.02,
              }}>
                Sport begins now.
              </h2>
              <p style={{
                fontSize: "1.0625rem", color: "rgba(255,255,255,0.45)",
                maxWidth: "400px", margin: "0 auto 2.5rem", lineHeight: 1.65,
              }}>
              ...
              <p style={{ marginTop: "1.75rem", fontSize: "0.8125rem", color: "rgba(255,255,255,0.2)", letterSpacing: "0.01em" }}>
