    ...
    <footer style={{ backgroundColor: "#0d0d0d" }}>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: "280px" }}>
          <Image src="/images/logo-attax-wh.svg" alt="Attax" width={80} height={30} style={{ display: "block", marginBottom: "1.25rem" }} />
          <p style={{
            fontSize: "0.875rem",
            ...
            The competitive game powered by your real fitness. Move more, fight harder, win your league.
          </p>
          <div style={{ display: "flex", gap: "8px" }}>
            ...
            <a href="https://play.google.com" target="_blank" rel="noopener noreferrer" style={{
              display: "inline-flex", alignItems: "center", gap: "6px",
              backgroundColor: "rgba(255,255,255,0.07)", color: "rgba(255,255,255,0.6)", fontWeight: 600, fontSize: "0.8125rem",
              padding: "9px 18px", borderRadius: "999px", textDecoration: "none",
      ...
      <div style={{
        ...
        <span style={{ fontSize: "0.8rem", color: "rgba(255,255,255,0.16)" }}>© 2025 Attax. All rights reserved.</span>
