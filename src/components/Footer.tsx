    ...
    <footer>
      ...
      <div style={{ position: "relative", overflow: "hidden", padding: "0 12px" }}>
        ...
        <div style={{ position: "relative", zIndex: 2, padding: "9rem 2rem 7rem", textAlign: "center" }}>
          <p style={{ fontSize: "0.75rem", fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", color: "rgba(255,255,255,0.45)", margin: "0 0 1.5rem" }}>
            Download
          </p>
          <h2 style={{ fontSize: "clamp(2.75rem, 5.5vw, 5rem)", fontWeight: 800, color: "#ffffff", letterSpacing: "-0.05em", lineHeight: 0.95, margin: "0 0 1.75rem" }}>
            Ready to enter<br />the arena?
          </h2>
          <p style={{ fontSize: "1.0625rem", color: "rgba(255,255,255,0.45)", lineHeight: 1.7, margin: "0 auto 3rem", maxWidth: "360px" }}>
        ...
        <div style={{ position: "relative", zIndex: 2, backgroundColor: "#ffffff", borderRadius: "20px 20px 0 0", overflow: "hidden" }}>
          ...
          <div style={{
            ...
            {/* Left: brand text */}
            <div style={{ position: "relative", zIndex: 1, padding: "3.5rem 3rem 3.5rem 4rem", display: "flex", flexDirection: "column", justifyContent: "center" }}>
              <Image
              ...
              />
              <p style={{ fontSize: "clamp(1.25rem, 2vw, 1.625rem)", fontWeight: 700, color: "#ffffff", letterSpacing: "-0.03em", lineHeight: 1.25, margin: "0 0 2rem", maxWidth: "320px" }}>
                The competitive game<br />powered by your fitness.
              </p>
              <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
                ...
                <a href="https://play.google.com" target="_blank" rel="noopener noreferrer" style={{
                  display: "inline-flex", alignItems: "center", gap: "7px",
                  backgroundColor: "rgba(255,255,255,0.09)", color: "rgba(255,255,255,0.7)", fontWeight: 600, fontSize: "0.875rem",
                  padding: "10px 20px", borderRadius: "999px", textDecoration: "none",
            ...
            <div style={{ position: "relative", zIndex: 1, overflow: "visible" }}>
              <div style={{
                ...
                /* Phone peeks upward: negative top shifts it above the band, clipped by parent overflow:hidden */
                top: "-40px",
              }}>
                <Image
