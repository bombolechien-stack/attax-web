    ...
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", flex: 1, justifyContent: "flex-end" }}>
        ...
        <a href="https://apps.apple.com" target="_blank" rel="noopener noreferrer" className="btn-white" style={{
          ...
          backgroundColor: "#ffffff", color: "#0d0d0d", fontWeight: 700, fontSize: "0.75rem",
          padding: "7px 14px", borderRadius: "999px", textDecoration: "none", whiteSpace: "nowrap",
        }}>
          <AppleIcon /> iOS
        </a>
        <a href="https://play.google.com" target="_blank" rel="noopener noreferrer" style={{
          display: "inline-flex", alignItems: "center", gap: "6px",
          backgroundColor: "rgba(255,255,255,0.1)", color: "rgba(255,255,255,0.85)", fontWeight: 700, fontSize: "0.75rem",
