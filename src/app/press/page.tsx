...
const LOGO_DARK_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1095.26 330.11" fill="white"><path d="M229.5,242.84H108.76L62.63,326.27H0L185.86,0h66.25l45.22,326.27H239.67Zm-97-46.13h92.7l-17-136.57h-1.13Z"/><path d="M331.3,277.88a129.44,129.44,0,0,1,2.26-22.83L360,132.72H324.29l9.27-44.09h35.73L381.5,29.85h55.39L424.46,88.63h50l-9.27,44.09H415.41l-24,111.7a72.93,72.93,0,0,0-2.27,17.18c0,16.28,10.86,22.84,30.08,22.84a97.19,97.19,0,0,0,16.28-1.13L426.27,326a142.6,142.6,0,0,1-27.82,2.72C358.43,328.76,331.3,311.8,331.3,277.88Z"/><path d="M482.17,277.88a128.6,128.6,0,0,1,2.27-22.83l26.45-122.33H475.16l9.28-44.09h35.72l12.21-58.78h55.39L575.33,88.63h50L616,132.72H566.28l-24,111.7a72.87,72.87,0,0,0-2.26,17.18c0,16.28,10.85,22.84,30.07,22.84a97,97,0,0,0,16.28-1.13L577.14,326a142.41,142.41,0,0,1-27.81,2.72C509.31,328.76,482.17,311.8,482.17,277.88Z"/><path d="M609.08,264.09c0-48.16,38.21-76.42,101.75-79.14l65.34-2.71,3.17-14.47a39.83,39.83,0,0,0,.9-10c0-19.44-15.15-31.65-41.6-31.65-27.14,0-43.87,12.43-48.39,31.65H636.44c7.91-45.67,48.84-76.65,106.49-76.65,55.17,0,92,28.72,92,70.32a103.05,103.05,0,0,1-1.81,19.9L800.36,326.27H747l6.11-28.94h-.91c-14.92,19.89-40,32.78-69.64,32.78C641.64,330.11,609.08,302.53,609.08,264.09Zm154.2-21.71,5.2-22.83-56.07,2.71c-30.52,1.13-48.84,14-48.84,34.37,0,18.54,16,30.52,39.34,30.52C732.08,287.15,757.4,268.61,763.28,242.38Z"/><path d="M950.33,243.29l-65.57,83H822.13L925,204,873,86.15h58.79l33.92,82.75h1.13l65.57-82.75h62.85L992.39,208.47l51.77,117.8H985.6l-33.91-83Z"/></svg>`;
  ...
  return (
    <div style={{ borderRadius: "16px", overflow: "hidden", border: "1px solid #ebebeb" }}>
      <div style={{
        ...
        justifyContent: "center",
        minHeight: "120px",
        border: bg === "#ffffff" ? "1px solid #ebebeb" : "none",
      }}>
        <div
          style={{ width: "160px" }}
          dangerouslySetInnerHTML={{
            __html: LOGO_DARK_SVG.replace('fill="white"', `fill="${bg === "#ffffff" ? "#0d0d0d" : "#ffffff"}"`)
          }}
        />
      </div>
